 ...
 * @summary Live
 */
export const healthLive = async ( options?: Parameters<typeof customInstance>[1]): Promise<healthLiveResponse> => {
 ...
 * @summary Ready
 */
export const healthReady = async ( options?: Parameters<typeof customInstance>[1]): Promise<healthReadyResponse> => {
