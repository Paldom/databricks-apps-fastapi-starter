 ...
 */
export const getUserSettings = async ( options?: Parameters<typeof customInstance>[1]): Promise<getUserSettingsResponse> => {
 ...
 */
export const updateUserSettings = async (userSettings: UserSettings, options?: Parameters<typeof customInstance>[1]): Promise<updateUserSettingsResponse> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateUserSettingsMutationVariables = {data: UserSettings}
