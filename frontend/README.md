...
../backend/openapi.yaml           # OpenAPI spec (generated by backend export)
...
If you update `../backend/openapi.yaml`, run `npm run api:gen` and commit the regenerated files. CI will fail if the generated code is stale.
