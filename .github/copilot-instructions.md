...
Rules for coding agents (Claude Code, Codex, Cursor, Copilot) working in this repository. `CLAUDE.md` and
`GEMINI.md` import this file. Keep it short and specific; anything that must always happen is enforced by hooks,
